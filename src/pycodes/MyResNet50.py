...
class Bottleneck(nn.Module):
    def __init__(self, in_places, places, stride=1, downsampling=False, expansion=4):
        ...
        self.expansion = expansion  #扩大的倍数
...
def ResNet50():
    return ResNet([3, 4, 6, 3], num_classes=2)
...
net_path = r'D:\PyCharm_workspace\resNet50\res\model\model.pkl'

if __name__ == '__main__':
    # model = torchvision.models.resnet50()
    model = ResNet50()
    print(model)
    # model.load_state_dict(torch.load(net_path, map_location="cuda"))
